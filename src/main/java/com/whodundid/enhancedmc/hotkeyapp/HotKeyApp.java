package com.whodundid.enhancedmc.hotkeyapp;

import com.whodundid.enhancedmc.core.EnhancedMC;
import com.whodundid.enhancedmc.core.app.AppType;
import com.whodundid.enhancedmc.core.app.EMCApp;
import com.whodundid.enhancedmc.core.app.RegisteredApps;
import com.whodundid.enhancedmc.core.app.config.AppConfigFile;
import com.whodundid.enhancedmc.core.app.config.AppConfigSetting;
import com.whodundid.enhancedmc.core.events.impl.AppsReloadedEvent;
import com.whodundid.enhancedmc.core.events.impl.EMCPostInitEvent;
import com.whodundid.enhancedmc.core.terminal.window.ETerminal;
import com.whodundid.enhancedmc.core.util.EUtil;
...
import com.whodundid.enhancedmc.hotkeyapp.control.types.CommandSenderHotkey;
import com.whodundid.enhancedmc.hotkeyapp.control.util.KeyComboAction;
import com.whodundid.enhancedmc.hotkeyapp.storage.HotKeyBuilder;
import com.whodundid.enhancedmc.hotkeyapp.storage.KeyLoader;
import com.whodundid.enhancedmc.hotkeyapp.storage.KeySaver;
import com.whodundid.enhancedmc.hotkeyapp.settings.InputDelay;
import com.whodundid.enhancedmc.hotkeyapp.terminal.CreateExampleKey;
import com.whodundid.enhancedmc.hotkeyapp.util.HKResources;
import com.whodundid.enhancedmc.hotkeyapp.util.IHaveHotkeys;
import com.whodundid.enhancedmc.hotkeyapp.window.HotKeyCreatorWindow;
import com.whodundid.enhancedmc.hotkeyapp.window.HotKeyListWindow;
import com.whodundid.enhancedmc.hotkeyapp.window.HotKeyMainWindow;
import com.whodundid.enhancedmc.hotkeyapp.window.HotKeySettingsWindow;
...
public final class HotKeyApp extends EMCApp {
	...
	public static final String MODID = "hotkeyapp";
	public static final String VERSION = "0.1.0-SNAPSHOT";
	public static final String NAME = "HotkeyApp";
	...
	private void searchForAppKeys() {
		for (EMCApp a : RegisteredApps.getAppsList()) {
			if (a instanceof IHaveHotkeys) {
				...
				if (keys != null) {
					keys.forEach(this::registerHotKey);
				}
			}
		} //for
	}
